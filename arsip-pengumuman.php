						...
						<?php
							...
							<div class="col-md-3">
								...
								<div class="card" style="width:250px; height:350px;">
									<a href="lihat-pengumuman.php?detail_id=<?php echo $data["id_info"];?>"><img src="administrator/info/hasil-upload/<?php echo $data["foto"];?>" style="padding:3px;width:248px;height:150px;"></a>
									<div class="card-body">
