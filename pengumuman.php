...
<head>
	...
	<title>RA Attaqwa 35 | Pengumuman</title>
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link activeku" href="pengumuman.php">Pengumuman</a>
							</li>
						</ul>
					</div>
				</nav>
							...
							<?php
								...
								<div class="col-md-3">
									...
									<div class="card" style="width:250px; height:350px;">
										<a href="lihat-pengumuman.php?detail_id=<?php echo $data["id_info"];?>"><img src="administrator/info/hasil-upload/<?php echo $data["foto"];?>" class="card-img-top" style="padding:3px;width:248px;height:150px;"></a>
										<div class="card-body">
											<p><i class="fas fa-calendar"></i> <?php echo $data["waktu"]; ?></p>
											<a href="lihat-pengumuman.php?detail_id=<?php echo $data["id_info"];?>"><p class="card-text"><?php echo $data["desk_singkat"]; ?></p></a>
										</div>
										<?php
